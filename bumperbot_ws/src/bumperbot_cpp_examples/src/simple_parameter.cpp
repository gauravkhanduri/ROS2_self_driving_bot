...
public:
    ...
    {
        declare_parameter<int>("simple_int_param", 2);
        declare_parameter<std::string>("simple_string_param", "Gourav");
...
int main(int argc, char *argv[])
{
    ...
    // print msg node has been started
    RCLCPP_INFO(rclcpp::get_logger("rclcpp"), "Node has been started");
