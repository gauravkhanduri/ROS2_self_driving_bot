...
NoisyController::NoisyController(const std::string& name) : Node(name), left_wheel_prev_pos_(0.0), right_wheel_prev_pos_(0.0)
    , x_(0.0)
    , y_(0.0)
    , theta_(0.0)
{
...
void NoisyController::jointCallback(const sensor_msgs::msg::JointState::SharedPtr msg)
{
